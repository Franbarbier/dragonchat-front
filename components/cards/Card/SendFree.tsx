                ...
                <div className={`${styles.table_rows} ${styles.enviando_table}`}>
                    {contactos.map((contact, index)=>(
                        ...
                        {contactos.length - 1 != index &&
                            ...
                            <div className={`${styles.row_card} ${contact.estado == "error" && styles.error} ${contact.estado == STATUS.SUCCESS && styles.success}`} key={contact.nombre+index} >
                                ...
                                <div className="column50">
                                    ...
                                    {contact.estado == STATUS.SUCCESS && <img className={styles.estado_envio} src="/check.svg" />}
                                    {contact.estado == STATUS.ERROR && <img className={styles.estado_envio} src="/close.svg" />}
                            </div>
                            }
                            </>
                        ))
