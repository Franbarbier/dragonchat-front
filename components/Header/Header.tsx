            ...
            <nav>
                <div>
                    <img width={'130px'} src={'dragonchat_logo_full.svg'} onClick={()=> logoClicked() } />
                        <span className={styles.proLogo}> {isPaid ? 2 : 1 }.0</span>

                        {isPaid ? <span className={styles.proLogo}>2.0</span> : <span className={styles.proLogo} style={{"cursor": "pointer"}} onClick={()=> setModalPro(true)}>1.0</span>}
